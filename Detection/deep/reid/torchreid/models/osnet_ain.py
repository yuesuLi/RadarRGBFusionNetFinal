...
def init_pretrained_weights(model, key=''):
    ...
    # torch_home = '/media/personal_data/zhangq/DeepSORT/Yolov5_DeepSort_Pytorch/deep_sort/deep'
    torch_home = '/mnt/ChillDisk/personal_data/zhangq/002/personalData/DeepSORT/Yolov5_DeepSort_Pytorch/deep_sort/deep'
