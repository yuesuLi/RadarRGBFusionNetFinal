...
class self_dataset2(Dataset):
    ...
    def __getitem__(self, item):
        ...
        curr_label = lidar_json['annotation']
        ...
        return rgb_img, img, rgb_json, OCU_data, OCU_json, lidar_json, curr_label, Lidar_points


if __name__ == '__main__':
    # data_dir = '/media/personal_data/zhangq/RadarRGBFusionNet2_20231128/dataset/datas/20221217_group0008_mode4_261frames'
    # label_dir ='/media/personal_data/zhangq/RadarRGBFusionNet2_20231128/dataset/labels/20221217_group0008_mode4_261frames'
    source = '/mnt/ourDataset_v2/ourDataset_v2_label/20221217_group0004_mode3_350frames'
    # 'ourdataset_v2/ourDataset_v2_label/20221217_group0008_mode4_261frames'
    dataset_train = self_dataset2(source)
    rgb_img, img, rgb_json, OCU_data, OCU_json, lidar_annotation, curr_label, Lidar_points = dataset_train[0]
