...
def draw_radarCulPoints_in_BEV(RadarDetections):
    ...
    #
    plt.scatter(drawPoints[:, 0], drawPoints[:, 1], s=50, marker='^', c=['b', 'g', 'r', 'm', 'y', 'k', 'c', 'orange', 'purple'], cmap='viridis')
...
def run(opt):
    ...
    for group_num, groupname in enumerate(datasets_path):
        ...
        for frame_idx, (rgb_img0, img, rgb_json, OCU_data, OCU_json, lidar_json, extendGT) in enumerate(dataset):
            ...
            imgSaveName = '/mnt/ChillDisk/personal_data/zhangq/RadarRGBFusionNet2/runs/frame48Result.png'
